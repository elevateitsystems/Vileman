    ...
    <div className="rounded-lg bg-white p-10 text-black shadow-[0_40px_80px_rgba(0,0,0,0.06)] border border-gray-100">
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center border-b border-gray-100 pb-6">
          ...
          <span className="text-[14px] font-bold uppercase tracking-widest text-[#3ed2a7]">
            Free
          </span>
        </div>
        <div className="flex justify-between items-center pt-4">
          ...
          <div className="text-right">
            ...
            <span className="text-[14px] font-light text-gray-400 uppercase tracking-widest">
              EUR
            </span>
          </div>
        </div>
      ...
      <p className="mt-6 text-center text-[13px] font-light text-gray-400 leading-relaxed">
        Payments are processed securely via encrypted channels. We accept all
        major credit cards.
      </p>
    </div>
  );
